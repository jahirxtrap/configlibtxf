...
public abstract class TXFConfig {
    ...
    public static class ConfigScreen extends Screen {
        ...
        public void init() {
            ...
            Button editorButton = this.addRenderableWidget(SpriteIconButton.builder(Component.empty(), button -> Util.getPlatform().openFile(FMLPaths.CONFIGDIR.get().resolve(modid + ".json").toFile()), true).sprite(new ResourceLocation("configlibtxf","icon/editor"), 12, 12).size(20, 20).build());
                ...
                if (info.modid.equals(modid) && (info.tab == null || info.tab == tabManager.getCurrentTab())) {
                    ...
                    if (info.function != null) {
                        ...
                        if (e.isColor()) {
                            ...
                            ).sprite(new ResourceLocation("configlibtxf", "icon/explorer"), 12, 12).size(20, 20).build();
    ...
    public static class ConfigListWidget extends ContainerObjectSelectionList<ButtonEntry> {
        ...
        @Override protected void renderDecorations(GuiGraphics c, int mouseX, int mouseY) {
