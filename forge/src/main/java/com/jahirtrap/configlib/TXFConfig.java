...
public abstract class TXFConfig {
    ...
    public static class ConfigScreen extends Screen {
        ...
        public void init() {
            ...
            this.addRenderableWidget(new SpriteIconButton(this.width / 2 - 182, this.height - 27, 20, 20, Component.empty(), button -> Util.getPlatform().openFile(FMLPaths.CONFIGDIR.get().resolve(modid + ".json").toFile()), new ResourceLocation("configlibtxf","textures/gui/sprites/icon/editor.png"), 12, 12));
