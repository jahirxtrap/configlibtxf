...
public abstract class TXFConfig {
    ...
    public static class ConfigScreen extends Screen {
        ...
        public void init() {
            ...
            Button editorButton = this.addRenderableWidget(TextAndImageButton.builder(Component.empty(), new ResourceLocation("configlibtxf","textures/gui/sprites/icon/editor.png"), button -> Util.getPlatform().openFile(FMLPaths.CONFIGDIR.get().resolve(modid + ".json").toFile())).textureSize(12, 12).usedTextureSize(12, 12).offset(0, 4).build());
