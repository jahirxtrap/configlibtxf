        ...
        public void fillList() {
            for (EntryInfo info : entries) {
                if (info.modid.equals(modid)) {
                    ...
                    Button resetButton = new SpriteIconButton(width - 205 + 150 + 25, 0, 20, 20, Component.literal(""), (button -> {
                    ...
                    if (info.function != null) {
                        ...
                        if (e.isColor()) {
                            Button colorButton = new Button(width - 185, 0, 20, 20, Component.literal("⬛"),
                                    button -> new Thread(() -> {
