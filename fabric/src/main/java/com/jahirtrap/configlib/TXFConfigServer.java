...
public class TXFConfigServer {
    private static final ResourceLocation SYNC_ID = new ResourceLocation("configlibtxf", "config_sync");
    ...
    public static void register() {
        ...
        if (FabricLoader.getInstance().getEnvironmentType() == EnvType.CLIENT) {
            ClientPlayNetworking.registerGlobalReceiver(SYNC_ID, (client, handler, buf, sender) -> {
