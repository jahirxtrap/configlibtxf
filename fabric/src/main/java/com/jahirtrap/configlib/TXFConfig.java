        ...
        public void renderWidget(PoseStack context, int mouseX, int mouseY, float delta) {
            ...
            if (item != null) {
                ...
                if (r != null) {
                    ...
                    optStack.ifPresent(stack -> renderItem(context, stack, this.getX() + (this.width - 16) / 2, this.getY() + (this.height - 16) / 2));
                }
            }
        }
