...
public class TXFConfigClient extends TXFConfig {
    ...
    public static class ConfigScreen extends Screen {
        ...
        public void init() {
            ...
            Button editorButton = this.addRenderableWidget(TextAndImageButton.builder(Component.empty(), new ResourceLocation("configlibtxf", "textures/gui/sprites/icon/editor.png"), button -> Util.getPlatform().openFile(FabricLoader.getInstance().getConfigDir().resolve(modid + ".json5").toFile())).textureSize(12, 12).usedTextureSize(12, 12).offset(0, 4).build());
