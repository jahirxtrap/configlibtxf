    ...
    public static class HubScreen extends Screen {
        ...
        public void init() {
            ...
            for (String key : keys) {
                ...
                }, true).sprite(ResourceLocation.fromNamespaceAndPath(MODID, "icon/editor"), 12, 12).size(20, 20).build();
                ...
                if (info.modid.equals(modid) && (info.tab == null || info.tab == tabManager.getCurrentTab())) {
                    ...
                    if (info.function != null) {
                        ...
                        if (e.isColor()) {
                            ...
                            ).sprite(ResourceLocation.fromNamespaceAndPath(MODID, "icon/explorer"), 12, 12).size(20, 20).build();
